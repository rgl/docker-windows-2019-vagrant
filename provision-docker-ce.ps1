...
# see https://github.com/moby/moby/releases/tag/v20.10.9
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v20.10.9

# download install the docker binaries.
$archiveVersion = '20.10.9'
...
$archiveHash = '360ca42101d453022eea17747ae0328709c7512e71553b497b88b7242b9b0ee4'
